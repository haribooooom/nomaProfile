...
はじめまして、のまです。
現在は、サービスのUIデザイン、デザインシステム運用、アクセシビリティ関連活動に携わっています。
また、デザインに限らず組織やカルチャー作りにも関心があります。

### 関心領域・取り組み
- サービスのデザイン、デザインシステム、アクセシビリティ
- 組織文化・チームビルディングへの関心
- 必要に応じて役割を問わず幅広く対応
- アクセシビリティ資格取得・社外勉強会への参加
...
* [職務経歴書（Github）](https://github.com/haribooooom/noma-resume/tree/master)
* [Figma](https://www.figma.com/proto/XakWfbhwCdLjqFqNmPtGaE/noma-Portfolio-open?page-id=3126%3A4902&node-id=5844-2552&viewport=461%2C-3247%2C0.26&t=r2WWyOxOLQBuR9Dz-1&scaling=min-zoom&content-scaling=fixed&starting-point-node-id=5844%3A2552)
...
良いお話があれば！ただし、本業があるため即座に連絡は取りにくいです。
...
### 🖋️ コアスキル
- **UI/UXデザイン**  
  プロダクト価値向上を目的としたインターフェース設計、ユーザー体験設計、プロトタイピング
- **デザインシステム構築・運用**  
  スケーラブルなコンポーネント設計とドキュメント化を通じた開発・デザイン効率化
- **アクセシビリティ推進**  
  ガイドラインに基づくデザイン改善、社内外啓蒙活動、チェックリスト作成・監修

### 🛠 周辺スキル
- **HTML/CSSの基礎実装**
  - 簡易なカスタマイズや、デザイン意図の伝達を補助
- **プロジェクト推進**
  - 社内外勉強会・イベント企画・ファシリテーション経験

### 🧰 使用ツール・技術スタック
- **デザイン**: Figma / Adobe Creative Cloud（Photoshop, Illustrator）
- **ドキュメント・ナレッジ管理**: Notion / Qiita / Google Workspace
- **コミュニケーション**: Slack / Zoom
- **バージョン管理**: GitHub
- **アクセシビリティチェック**: Axe DevTools / Lighthouse
- **生成AIツール活用**: ChatGPT / v0 / Cursor
- **開発補助**: Visual Studio Code
...
豊かな人生とは、物質的な豊かさだけでなく、精神的な充実感や選択の自由、前向きな生き方を含むものです。ミッションを通じて、人々が自己実現を追求し、より幸せな生活を送るサポートを目指しています。

### ビジョン

📚**知ることで、選択の自由を作る**  
知識が選択肢を広げ、人々が自分の人生をより自由にコントロールできるようにしたいです。知識を得ることで、新しい選択肢や可能性が見え、これまで考えられなかった道が開かれます。
...
🎓**ともに学ぶ**  
個々の知識や経験を共有し合い、ともに学ぶことで、より大きな成果を達成できます。協力し合うことで、互いに高め合うことも期待しています。

🚶‍➡️**まず行動**  
まず行動してみることで、学びと成長の機会を得られます。自分の理想を持ち、計画をたて関係者と調整しものごとを進めていきます。
